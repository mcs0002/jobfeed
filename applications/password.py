...
`applications/account.py` used to hand the generated password back as JSON so
...
from applications.account import WORKFLOW_RE, _keychain, _profile_email
from applications.handoff import safe_application_url
