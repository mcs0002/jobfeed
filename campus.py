...
WHY THIS EXISTS
`campus_sweep.py` reads every graduate-programme page the ATS scrape cannot
...
from campus_sweep import OUT_ROOT, _norm, load_walls, reconcile_window

# Order the page is worked in: what closes soonest, first.
