...
jobfeed/filter.py drops the ops/retail/IT noise, the Haiku tagger sorts divisions). The
...
with a jobfeed/filter.py drop set, so the positive cut stays strictly more permissive
