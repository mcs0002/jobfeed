...
Pure Python, no LLM. Wired into ``jobfeed/selfcheck.py``; also runnable directly:

    python3 -m jobfeed.tag_health            # full per-company table (worst first)
    python3 -m jobfeed.tag_health --alert    # only other-heavy companies; exit 1 if any
"""
import argparse
import os
import sqlite3
