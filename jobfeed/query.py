...
Usage:
  python3 -m jobfeed.query                          # list all stored roles
  python3 -m jobfeed.query --status new             # filter by status
  python3 -m jobfeed.query --category Bank          # filter by category (substring)
  python3 -m jobfeed.query --company "Jane Street"  # filter by company (substring)
  python3 -m jobfeed.query --export roles.csv       # export matching roles to CSV
  python3 -m jobfeed.query --mark <job_id> applied  # set a role's status
