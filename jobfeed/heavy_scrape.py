...
sweep) can't run inside jobfeed/main.py's ThreadPoolExecutor: a worker thread that
...
single JSON object on stdout: {"jobs": [...], "error": null|str}.
  ...
  python -m jobfeed.heavy_scrape --company "J.P. Morgan"
"""
import argparse
import json
import sys

from jobfeed.main import load_targets, scrape_company
